...
var VolumeRenderShaderSampling = {
	uniforms: {
...
var VolumeRenderShaderIntegrating = {	
	uniforms: {
		"u_size": { value: new Vector3( 1, 1, 1 ) },
		"u_renderstyle": { value: 0 },
		"u_iso_threshold": { value: 0.5 },
		"u_iso_ambient_color": { value: new Color(0.2, 0.4, 0.2) },
		"u_iso_diffuse_color": { value: new Color(0.8, 0.2, 0.2) },
		"u_iso_specular_color": { value: new Color(1.0, 1.0, 1.0) },
		"u_iso_shininess": { value: 40 },
		"u_clim": { value: new Vector2( 1, 1 ) },
		"u_data": { value: null },
		"u_cmdata": { value: null }
	},
	...
	fragmentShader: [
		...
		//" gl_FragColor = vec4(fract(frontpos),1.); return;", // For testing: show the front voxels
		//" gl_FragColor = vec4(fract(backpos),1.); return;", // For testing: show the back voxels
		...
		// Calculate colors
		"						ambient_color +=	mask1 * u_iso_ambient_color;	// * gl_LightSource[i].ambient;",
...
export { VolumeRenderShaderSampling, VolumeRenderShaderIntegrating };
